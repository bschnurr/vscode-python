...
import { ILanguageServerAnalysisOptions, ILanguageServerCache } from '../../client/activation/types';
...
export class DataScienceIocContainer extends UnitTestIocContainer {
    ...
    public registerDataScienceTypes() {
        ...
        this.serviceManager.addSingleton<ILanguageServerCache>(ILanguageServerCache, MockLanguageServerCache);
